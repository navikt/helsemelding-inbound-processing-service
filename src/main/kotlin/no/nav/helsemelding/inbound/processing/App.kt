...
import no.nav.helsemelding.inbound.processing.plugin.configureMetrics
import no.nav.helsemelding.inbound.processing.plugin.configureRoutes
...
private fun logError(t: Throwable) = log.error(t) { "Shutdown inbound processing service" }
